        ...
        try {
            ...
            Pair_Code_By_Arslan_Tech.ev.on('connection.update', async (s) => {
                ...
                if (connection === 'open') {
                    ...
                    let session = await Pair_Code_By_Arslan_Tech.sendMessage(Pair_Code_By_Arslan_Tech.user.id, { text: '𝕾𝖔𝖋𝖙𝖜𝖆𝖗𝖊_𝖉𝖊𝖛' + b64data });
...
║❍ 𝐖𝐚𝐆𝗿𝐨𝐮𝐩: https://chat.whatsapp.com/IuuwSArp5YI05RP7XkgX1a?mode=gi_t
║❍ 𝐖𝐚𝐂𝐡𝐚𝐧𝐧𝐞𝐥: https://whatsapp.com/channel/0029Vb7nKMf4IBhCEM7kvK2Z
║
║ ☬ ☬ ☬ ☬
╚═════════════════════╝
𒂀 Enjoy 𝕾𝖔𝖋𝖙𝖜𝖆𝖗𝖊_𝖉𝖊𝖛
